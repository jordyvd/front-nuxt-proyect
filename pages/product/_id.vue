<template>
  <div>
    <Menu :home="false" />
    <b-overlay :show="skeleton" spinner-variant="primary">
              ...
              <div class="s_product_text">
                ...
                <div class="card_area">
                  ...
                  <div class="add_to_cart">
                    <a href="" @click.prevent="addProduct()" class="btn_3 cursor">agregar</a>
...
export default {
  ...
  methods: {
    getDetails() {
      ...
      axios
        .post(this.webService + "/api/product/details", params)
        .then((res) => {
